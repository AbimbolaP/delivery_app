...
import HeroBg from "../img/heroBg-min.png"
    ...
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home' >
      <div className="py-2 flex-1 flex flex-col items-start  justify-center gap-6">
        ...
        <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolorem voluptatibus iusto et pariatur veritatis cumque velit repellendus, voluptate quisquam reiciendis excepturi tempore harum inventore autem incidunt asperiores distinctio cupiditate sequi?
        </p>
      ...
      <div className="py-2 flex-1 flex items-center relative">
        <img src={HeroBg} className='ml-auto h-370 w-full md:h-510 lg:w-auto lg:h-650' alt='hero-bg'/>
