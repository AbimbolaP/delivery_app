      ...
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        {
          ...
          <div className='group flex justify-center items-center flex-col border-2 bborder-dotted border-gray-300 w-full h-225 md:h-420 cursor-pointer rounded-lg'>
                {isLoading ? (
                <Loader/>
                ) : (
                <>
                  {!imageAsset ? (
                    ...
                    <div className='relative h-full'>
                      ...
                      <button type='button' className='absolute ottom-3 right-3 p-3 rounded-full bg-red-500 text-xl cursor-pointer outline-none hover:shadow-md duration-500 transition-all ease-in-out'  onClick={deleteImage}>
          ...
          <div className='w-full flex flex-col md:flex-row items-center justify-center '>
            <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
              ...
              <input  
                ...
                className='w-full h-full text-lg bg-transparent outline-none border-none placeholder:text-grray-400 text-textColor'/>
            </div>
